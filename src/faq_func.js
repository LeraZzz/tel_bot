module.exports ={
    ...
    goTo7Faq: function(tg, callbackQuery){
     let text = '<b>Как использовать масло при коньюктивите? Не будет ли больно глазам?</b>>\n' +
         '\n' +
    ...
    goTo6Faq: function(tg, callbackQuery){
        let text = '<b>Как масло может помочь от стоматита? Полость рта надо смывать? </b>\n' +
            '\n' +
